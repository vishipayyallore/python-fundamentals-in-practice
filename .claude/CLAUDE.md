# 🤖 Claude AI Configuration for Python Fundamentals Project
...
> This file contains Claude-specific configuration and detailed instructions.  
> See the root-level [`CLAUDE.md`](../CLAUDE.md) for the full set of guidelines.
...
- **Full Claude Guidelines**: [`CLAUDE.md`](../CLAUDE.md) - Root-level Claude instructions
