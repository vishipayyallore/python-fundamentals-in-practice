...
- ✅ Being respectful and kind to all learners, regardless of their experience level
- ✅ Using welcoming and inclusive language
- ✅ Being patient with beginners who are learning
- ✅ Providing constructive feedback that helps others learn
...
This is an **educational repository** focused on helping beginners learn Python. We expect all participants to:

- **Be Patient**: Remember that everyone learns at different paces
- **Be Encouraging**: Support learners in their journey, even when they make mistakes
- **Be Clear**: Provide explanations that help others understand concepts
- **Be Respectful**: Value different perspectives and learning styles
...
This Code of Conduct is adapted from the [Contributor Covenant](https://www.contributor-covenant.org), version 2.1, available at [Contributor Covenant Code of Conduct v2.1](https://www.contributor-covenant.org/version/2/1/code_of_conduct/)
