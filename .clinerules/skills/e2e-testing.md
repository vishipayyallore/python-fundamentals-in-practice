---
name: e2e-testing
description: Legacy filename retained. Smoke verification for Python Fundamentals practice scripts - compileall plus selected interactive calculator input checks.
---
