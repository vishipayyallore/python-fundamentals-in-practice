...
| [`.clinerules/`](.clinerules/) | Cline-facing mirrors for rules, skills, agents, and workflows; canonical policy remains in root/`.cursor` files |
| [`.opencode/`](.opencode/) | OpenCode plugin config plus tool-facing rules, skills, agents, and prompts; `node_modules/` is ignored |
